...
export class PhotosService {
  ...
  public async addNewToGallary() {
    ...
    const saveImageFile = await this.savePhotos(capturePhoto);
    Storage.set({
      ...
      value: this.platform.is("hybrid")
        ...
        : JSON.stringify(this.photos.map(p => {
          const photoCopy = { ...p };
          console.log(photoCopy,photoCopy.base64)
  ...
  public async savePhotos(cameraPhoto: CameraPhoto) {
  ...
  public async loadSaved() {
    ...
    this.photos = JSON.parse(photo.value) || [];
    if (this.platform.is('hybrid')) {
